    ...
    <div>
      <div className="SignUpModal">
        <div className="navigation">
          <Button className="signUp" color="danger" onClick={toggleSignUp}>
            {buttonLabel}Sign Up
          </Button>
        </div>
        ...
        <Modal isOpen={modalSignUp} toggle={toggleSignUp} className={className}>
          ...
          <ModalBody>
            ...
            <form onSubmit={handleSubmitSignUp}>
              ...
              <button id="submitButton" type="submit" className="btn btn-primary btn-block">
                Sign Up
              </button>
              <p className="Login">
        ...
        <Modal isOpen={modalSignIn} toggle={toggleSignIn} className="signInModal">
          ...
          <ModalBody>
            <form onSubmit={handleSubmitSignIn}>
              ...
              <button id="submitButton" type="submit" className="btn btn-primary btn-block" onClick={toggleSignIn}>
                Sign In
              </button>
            </form>
          </ModalBody>
